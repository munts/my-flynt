...
namespace Flynt\Components\GridPostsStaff;
...
add_filter('Flynt/addComponentData?name=GridPostsStaff', function ($data) {
    $postType = POST_TYPE;
...
Options::addTranslatable('GridPostsStaff', [
    [
